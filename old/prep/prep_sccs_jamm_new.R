...
scc_obs_150_100 <- getObsOnly(usa_bfs,usa_insects,cellsize_km = 250, min_per_cell_n=75,sample_cutoff_n=150,floor_hours = F)

# divide data into species season cells with difference metrics from baseline
# setting sampling cutoff to a trivially high amount means it is ignored
scc_estimates_bfs <- estimateSpeciesSeasonCellForaging(usa_bfs,usa_insects,cellsize_km=150,
                                                       ...
                                                       min_per_cell_n = 100, sample_cutoff_n = 100000000, floor_hours=FALSE,
