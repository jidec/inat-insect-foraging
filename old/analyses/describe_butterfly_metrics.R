...
plotHist(sscs,colname="diff_third1_sum")

# hists of all pigment percents
hist(sscs$diff_third1_mean,main="Morning activity is right tailed - most species active more in morning than baseline",
     xlab="Mean diff in the 1st third of the day (0-4 solar)", breaks=200)
hist(sscs$diff_third2_mean,main="Noon activity is left tailed - most species active less at noon than baseline",
     xlab="Mean diff in the 2nd third of the day (5-8 solar)",breaks=200)
hist(sscs$diff_third3_mean,main="Afternoon/evening activity is centered - on average no diff from baseline!",
     xlab="Mean diff in the 3rd third of the day (9-12 solar)",breaks=200)
