...
weib_percentile(a_syriaca$doy, percentile = 0.1, iterations = 5)
View(a_syriaca)
...
# pick 50 cells with significant anova and 50 without

shiny::runGitHub('roleShiny', 'role-model',ref="shiny-restructure")
