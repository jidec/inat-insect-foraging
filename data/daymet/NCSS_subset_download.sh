...
echo $i
	...
	echo $par
		...
		#wget -O ${par}_${i}_${startmn}subset.nc "http://thredds.daac.ornl.gov/thredds/ncss/grid/ornldaac/1840/daymet_v4_daily_${region}_${par}_${i}.nc?var=lat&var=lon&var=${par}&north=${north}&west=${west}&east=${east}&south=${south}&horizStride=482&time_start=${i}-${startmn}-${startday}T12:00:00Z&time_end=${i}-${endmn}-${endday}T12:00:00Z&timeStride=1&accept=netcdf"
			# An example using cURL					
		curl -o ${par}_${i}_${startmn}subset.nc "https://thredds.daac.ornl.gov/thredds/ncss/grid/ornldaac/1840/daymet_v4_daily_${region}_${par}_${i}.nc?var=lat&amp;var=lon&amp;var=${par}&amp;north=${north}&amp;west=${west}&amp;east=${east}&amp;south=${south}&amp;horizStride=482&amp;time_start=${i}-${startmn}-${startday}T12:00:00Z&amp;time_end=${i}-${endmn}-${endday}T12:00:00Z&timeStride=1&amp;accept=netcdf"
